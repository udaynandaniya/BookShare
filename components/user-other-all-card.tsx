...
import { MapPin, Eye, Share2, User, Phone, MessageCircle, Heart } from "lucide-react"
...
interface UserOtherAllCardProps {
  book: any
  onView: (book: any) => void
}

export function UserOtherAllCard({ book, onView }: UserOtherAllCardProps) {
      ...
      <CardContent className="p-0">
        ...
        <div className="relative aspect-[4/5] overflow-hidden">
          ...
          <div className="absolute top-3 left-3">
            <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-semibold backdrop-blur-md shadow-lg transition-all duration-300 hover:scale-105 flex items-center gap-1">
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex gap-3 pt-2">
            <Button
              size="sm"
              className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-sm h-10 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg shadow-blue-500/25"
              onClick={(e) => {
                e.stopPropagation()
                handleContact("call")
              }}
            ...
            <Button
              size="sm"
              className="flex-1 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white text-sm h-10 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg shadow-green-500/25"
              onClick={(e) => {
                e.stopPropagation()
                handleContact("whatsapp")
              }}
