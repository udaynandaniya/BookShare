...
import { Edit, Trash2, MapPin, Eye, Share2, Crown } from "lucide-react"
...
interface AdminOwnPostCardProps {
  book: any
...
export function AdminOwnPostCard({ book, onEdit, onDelete, onView }: AdminOwnPostCardProps) {
      ...
      <CardContent className="p-0">
        ...
        <div className="relative aspect-[4/5] overflow-hidden">
          ...
          <div className="absolute top-3 left-3">
            <Badge className="bg-gradient-to-r from-yellow-500 to-amber-500 text-white text-xs font-semibold backdrop-blur-md shadow-lg transition-all duration-300 hover:scale-105 flex items-center gap-1">
