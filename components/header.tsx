...
import { BookOpen, Menu, User, Settings, LogOut, Plus, Search, Home } from "lucide-react"
...
export function Header() {
      ...
      <div className="container mx-auto px-4 sm:px-6 py-3">
        <div className="flex h-20 items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-3xl font-semibold tracking-tight text-white">NavneetHub</span>
          </Link>
          ...
          <nav className="hidden md:flex gap-6 items-center">
            {navItems.map(({ name, href, icon: Icon, protected: isProtected }) => (
              <button
                key={name}
                onClick={() => (isProtected ? handleProtectedRoute(href) : router.push(href))}
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              ...
              //     </Avatar>
              //   </DropdownMenuTrigger>
              //   <DropdownMenuContent className="w-60 bg-slate-900 border border-purple-700/50 shadow-xl" align="end">
              //     <div className="p-3 space-y-1">
              //       <p className="text-white font-semibold">{user.fullName || user.name}</p>
              ...
              //     </DropdownMenuItem>
              //     <DropdownMenuItem asChild>
              //       <Link href="/profile/edit" className="flex items-center gap-2 text-white hover:text-purple-300">
  ...
  <DropdownMenuContent className="w-60 bg-slate-900 border border-purple-700/50 shadow-xl" align="end">
    ...
    <DropdownMenuItem asChild>
      <Link href="/forgot-password" className="flex items-center gap-2 text-white hover:text-purple-300">
    ...
    >
      ...
      Logout
              ...
              <div className="hidden md:flex gap-3">
                <Link href="/login">
                  <Button className="group relative px-5 py-2 text-lg font-semibold text-white bg-gradient-to-r from-purple-600 to-purple-800 rounded-xl border border-purple-700 hover:from-purple-500 hover:to-purple-700 active:translate-y-[1px] before:absolute before:inset-0 before:rounded-xl before:border before:border-purple-400 before:animate-border-glow before:z-[-1]">
                    Login
                  </Button>
                </Link>
                <Link href="/signup">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="bg-slate-900 border-l border-purple-700/40">
