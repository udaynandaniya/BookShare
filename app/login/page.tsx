...
// // //     // If user is already logged in, avoid rendering the login form
// // //     if (user) return null
...
// // //     if (response.ok) {
// // //       login(data.user) // ✅ updates context
// // //       toast({
// // //         title: t("success"),
...
// //   // Redirect logged-in users without rendering anything
// //   useEffect(() => {
// //     if (user) {
// //       router.replace("/")
// //     }
...
// //   if (user) {
// //     // Return an empty fragment while redirecting to avoid rendering the page
// //     return <></>
// //   }
...
// //         // Delay redirect slightly to let context update
// //         setTimeout(() => {
// //           router.push("/dashboard")
// //         }, 100)
// //       } else {
...
//   headers: { "Content-Type": "application/json" },
//   body: JSON.stringify(formData),
//   credentials: "include", // This tells browser to accept & send cookies
// })
...
export default function LoginPage() {
  ...
  // duration: 10000, // show for 30 seconds
